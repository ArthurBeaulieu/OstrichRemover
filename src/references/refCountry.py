class RefCountry(object):
    ...
    countryList = ['ATG', 'AFG', 'DZA', 'AZE', 'ALB', 'ARM', 'AND', 'AGO', 'ARG', 'AUS', 'AUT', 'BHR', 'BRB', 'BWA',
                   ...
                   'CUB', 'CPV', 'CYP', 'CZE', 'DNK', 'DJI', 'DMA', 'DOM', 'ECU', 'EGY', 'GNQ', 'EST', 'ERI', 'SLV',
                   'ETH', 'FIN', 'FJI', 'FRA', 'FYR', 'GMB', 'GAB', 'DEU', 'GEO', 'GHA', 'GRD', 'GRC', 'GTM', 'GIN',
                   'GUY', 'HTI', 'HND', 'HRV', 'HUN', 'ISL', 'IDN', 'IRL', 'IND', 'IRN', 'ISR', 'ITA', 'CIV', 'IRQ',
                   'JPN', 'JAM', 'JOR', 'KEN', 'KGZ', 'PRK', 'KIR', 'KOR', 'KWT', 'KAZ', 'LAO', 'LBN', 'LVA', 'LTU',
                   'LBR', 'LIE', 'LSO', 'LUX', 'LBY', 'MDG', 'FSM', 'MDA', 'MNG', 'MWI', 'MLI', 'MCO', 'MAR', 'MUS',
                   'MRT', 'MNP', 'MHL', 'MLT', 'ODM', 'MDV', 'MEX', 'MYS', 'MOZ', 'NER', 'VUT', 'NGA', 'NLD', 'NOR',
                   'NPL', 'NRU', 'SUR', 'NIC', 'NZL', 'PRY', 'PER', 'PAK', 'POL', 'PAN', 'PRT', 'PNG', 'GNB', 'PLW',
